 ...
 *      SpritePixelCollider.java (must-have when integrating SPPS),
...
public class SpritePixelCollider {
     ...
     */
    public boolean intersectsSPC(Vector2Di spritePos1, Vector2Di spritePos2, SpritePixelCollider sprite2Collider) {
        SPCData.TOTAL_COLLISION_CHECKS++;
     ...
     * @param sprite2Collider Second sprite collider.
     */
    public boolean intersectsSPC(int sprite1X, int sprite1Y, int sprite2X, int sprite2Y, SpritePixelCollider sprite2Collider) {
     ...
     * @param sprite2Collider Second sprite collider.
     */
    public boolean intersectsSPCBaked(Vector2Di spritePos, SpritePixelCollider sprite2Collider) {
        SPCData.TOTAL_COLLISION_CHECKS++;
     ...
     * @param sprite2Collider Second sprite collider.
     */
    public boolean intersectsSPCBaked(int spriteX, int spriteY, SpritePixelCollider sprite2Collider) {
