EzXML is a high-level layer between JavaX.XML and W3C.DOM + (Java IO) with utilities to simplify some things. It allows you to read or write XML easier and faster.
...
(You can read/write XML file at the same time.)
