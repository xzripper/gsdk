...
<h3 align="center"><a href="https://github.com/violent-studio/vsdk/blob/main/vsdk/examples%26docs/VLib.Vinet.TCP.md">GSDK Chat implementation via Vinet (Violent Immediate mode Networking library).</a></h3>
