...
/**
 * Reflexia ImGui theme.
 */
public class ReflexiaTheme {
    /**
     * Update ImGui theme.
     */
    public static void updateTheme() {
        ...
        colors[ImGuiCol.WindowBg] = new float[] {0.12f, 0.12f, 0.12f, 1.00f};
        colors[ImGuiCol.ChildBg] = new float[] {0.00f, 0.00f, 0.00f, 0.00f};
        colors[ImGuiCol.PopupBg] = new float[] {0.18f, 0.18f, 0.18f, 0.92f};
        colors[ImGuiCol.Border] = new float[] {0.19f, 0.19f, 0.19f, 0.29f};
        colors[ImGuiCol.BorderShadow] = new float[] {0.00f, 0.00f, 0.00f, 0.24f};
        colors[ImGuiCol.FrameBg] = new float[] {0.20f, 0.20f, 0.20f, 0.54f};
        colors[ImGuiCol.FrameBgHovered] = new float[] {0.25f, 0.25f, 0.25f, 0.54f};
        colors[ImGuiCol.FrameBgActive] = new float[] {0.30f, 0.30f, 0.30f, 1.00f};
        colors[ImGuiCol.TitleBg] = new float[] {0.09f, 0.09f, 0.09f, 1.00f};
        colors[ImGuiCol.TitleBgActive] = new float[] {0.12f, 0.12f, 0.12f, 1.00f};
        ...
        colors[ImGuiCol.ScrollbarBg] = new float[] {0.12f, 0.12f, 0.12f, 0.54f};
        ...
        colors[ImGuiCol.Button] = new float[] {0.20f, 0.20f, 0.20f, 0.54f};
        colors[ImGuiCol.ButtonHovered] = new float[] {0.25f, 0.25f, 0.25f, 0.54f};
        colors[ImGuiCol.ButtonActive] = new float[] {0.30f, 0.30f, 0.30f, 1.00f};
        colors[ImGuiCol.Header] = new float[] {0.25f, 0.25f, 0.25f, 0.52f};
        colors[ImGuiCol.HeaderHovered] = new float[] {0.30f, 0.30f, 0.30f, 0.36f};
        colors[ImGuiCol.HeaderActive] = new float[] {0.35f, 0.35f, 0.35f, 0.33f};
        ...
        colors[ImGuiCol.DockingEmptyBg] = new float[] {0.10f, 0.10f, 0.10f, 1.00f};
        colors[ImGuiCol.PlotLines] = new float[] {0.90f, 0.90f, 0.90f, 1.00f};
        colors[ImGuiCol.PlotLinesHovered] = new float[] {1.00f, 0.70f, 0.00f, 1.00f};
        colors[ImGuiCol.PlotHistogram] = new float[] {0.90f, 0.90f, 0.90f, 1.00f};
        colors[ImGuiCol.PlotHistogramHovered] = new float[] {1.00f, 0.60f, 0.00f, 1.00f};
        colors[ImGuiCol.TableHeaderBg] = new float[] {0.19f, 0.19f, 0.19f, 0.52f};
        colors[ImGuiCol.TableBorderStrong] = new float[] {0.19f, 0.19f, 0.19f, 0.52f};
        colors[ImGuiCol.TableBorderLight] = new float[] {0.28f, 0.28f, 0.28f, 0.29f};
        colors[ImGuiCol.TableRowBg] = new float[] {0.10f, 0.10f, 0.10f, 0.00f};
        ...
        colors[ImGuiCol.NavHighlight] = new float[] {0.33f, 0.67f, 0.86f, 1.00f};
        ...
        colors[ImGuiCol.ModalWindowDimBg] = new float[] {0.20f, 0.20f, 0.20f, 0.35f};
