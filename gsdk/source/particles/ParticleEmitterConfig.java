...
public class ParticleEmitterConfig {
     ...
     */
    public void setDelta(float delta_) { delta = delta_; }
     ...
     */
    public boolean deltaUpdated() { return delta != -1.0f; }
     ...
     */
    public void setExplosiveness(float explosiveness_) { explosiveness = explosiveness_; }

    /**
     * Get particles explosiveness.
     */
    public float getExplosiveness() { return explosiveness; }
     ...
     * @param emissionRate_ Emission rate.
     */
    public void setEmissionRate(float emissionRate_) { emissionRate = emissionRate_; }
     ...
     */
    public void setEmissionVelocity(EmissionVelocity velocity) { emissionVelocity = velocity; }

    /**
     * Get emission velocity.
     */
    public EmissionVelocity getEmissionVelocity() { return emissionVelocity; }
     ...
     */
    public void setPFade(float pFade_) { pFade = pFade_; }

    /**
     * Get particles fade.
     */
    public float getPFade() { return pFade; }
     ...
     */
    public void setInversedEmission(boolean inversedEmission_) { inversedEmission = inversedEmission_; }

    /**
     * Is emission inversed?
     */
    public boolean getInversedEmission() { return inversedEmission; }
     ...
     * @param blending_ Particles blending.
     */
    public void setBlending(ParticleBlending blending_) { blending = blending_; }

    /**
     * Get particles blending.
     */
    public ParticleBlending getBlending() { return blending; }

    /**
     * Is blending available?
     */
    public boolean blendingAvailable() { return blending != null && !blending.isNone(); }
     ...
     */
    public void setPLifetime(float pLifetime_) { pLifetime = pLifetime_; }

    /**
     * Get particles lifetime.
     */
    public float getPLifetime() { return pLifetime; }
     ...
     */
    public void setPScale(float pScale_) { pScale = pScale_; }
     ...
     */
    public void setPRotation(float rotation) { pRotation = rotation; }

    /**
     * Get particles rotation.
     */
    public float getPRotation() { return pRotation; }
     ...
     */
    public void setPAlpha(float pAlpha_) { pAlpha = pAlpha_; }

    /**
     * Get particles alpha.
     */
    public float getPAlpha() { return pAlpha; }
     ...
     */
    public void setPColor(Vector3Di pColor_) { pColor = pColor_; }

    /**
     * Get particles color.
     */
    public Vector3Di getPColor() { return pColor; }
     ...
     */
    public void setPType(ParticleType pType_) { pType = pType_; }

    /**
     * Get particles type.
     */
    public ParticleType getPType() { return pType; }
}
